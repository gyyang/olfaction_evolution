...
standard.analysis_pn2kc_training.plot_distribution(path, dir_ix=0, epoch = epoch, xrange=1, log=True)
standard.analysis_pn2kc_training.plot_distribution(path, dir_ix=0, epoch = epoch, xrange=1, log=False)
standard.analysis_pn2kc_training.plot_sparsity(path, dir_ix=0, dynamic_thres=True, epoch=epoch)
